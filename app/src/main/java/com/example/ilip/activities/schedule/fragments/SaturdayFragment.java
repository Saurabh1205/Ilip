...
public class SaturdayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_saterday, container, false);
        Bundle extras;
        ...
        recyclerView = view.findViewById(R.id.Saturday);
        ...
        holidayImg = view.findViewById(R.id.sat);
        getScheduleDayWise();
    ...
    public void getScheduleDayWise() {
        ...
        postParam.put("PI_WEEK_DAY_ID", "7");
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, url, new JSONObject(postParam), response -> {
            ...
            try {
                if (response != null) {
                    ...
                    Log.e("Saturday", "url date =====" + response);
