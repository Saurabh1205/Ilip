...
public class MondayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.e("MondayFrame", "Data" + commonModel);
        recyclerView = view.findViewById(R.id.Monday);
        fab = view.findViewById(R.id.fab_Monday);
        fab.hide();
        fab.setOnClickListener(v -> ExtraLectureLayoutView(v.getContext()));
        holidayImg = view.findViewById(R.id.mon);
    ...
    public void getScheduleDayWise() {
        ...
        postParam.put("PI_WEEK_DAY_ID", "2");
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, url, new JSONObject(postParam), response -> {
            ...
            try {
                if (response != null) {
                    ...
                    Log.e("Monday", "url date =====" + response);
        ...
        Log.e("Exception Error","error="+error);
            nestedProgress.setVisibility(View.GONE);
        }) {
            @Override
