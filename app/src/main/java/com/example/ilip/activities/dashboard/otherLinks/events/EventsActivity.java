...
public class EventsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = findViewById(R.id.toolbar4Events);
        toolbar.setTitle("");
    ...
    public void getData() {
        ...
        postParam.put("PI_NOTICE_PATTERN", "EVENTBOX");
        Log.e("Event",url+"is=="+new JSONObject(postParam));
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, url, new JSONObject(postParam), response -> {
            Log.e("Response for", "Events" + response);
            try {
                ...
                if (response.getString("STATUS").equals("TRUE")) {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        otherLinkCommonModel.setLocation(jsonObject.getString("LOCATION"));
                    ...
                    AdaptorForEvents adaptorForNews = new AdaptorForEvents(arrayList, getApplicationContext());
