...
public class OtpView extends AppCompatEditText {
    ...
    private static final int[] FILLED_STATE = new int[]{
            com.example.ilip.R.attr.OtpState_filled
    };
    ...
    public OtpView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, com.example.ilip.R.attr.otpViewStyle);
    }
    ...
    public OtpView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        viewType = typedArray.getInt(com.example.ilip.R.styleable.OtpView_OtpViewType, VIEW_TYPE_NONE);
        otpViewItemCount = typedArray.getInt(com.example.ilip.R.styleable.OtpView_OtpItemCount, DEFAULT_COUNT);
        otpViewItemHeight = (int) typedArray.getDimension(com.example.ilip.R.styleable.OtpView_OtpItemHeight,
                res.getDimensionPixelSize(com.example.ilip.R.dimen.otp_view_item_size));
        otpViewItemWidth = (int) typedArray.getDimension(com.example.ilip.R.styleable.OtpView_OtpItemWidth,
                res.getDimensionPixelSize(com.example.ilip.R.dimen.otp_view_item_size));
        otpViewItemSpacing = typedArray.getDimensionPixelSize(com.example.ilip.R.styleable.OtpView_OtpItemSpacing,
                res.getDimensionPixelSize(com.example.ilip.R.dimen.otp_view_item_spacing));
        otpViewItemRadius = (int) typedArray.getDimension(com.example.ilip.R.styleable.OtpView_OtpItemRadius, 0);
        lineWidth = (int) typedArray.getDimension(com.example.ilip.R.styleable.OtpView_OtpLineWidth,
                res.getDimensionPixelSize(com.example.ilip.R.dimen.otp_view_item_line_width));
        lineColor = typedArray.getColorStateList(com.example.ilip.R.styleable.OtpView_OtpLineColor);
        isCursorVisible = typedArray.getBoolean(com.example.ilip.R.styleable.OtpView_android_cursorVisible, true);
        cursorColor = typedArray.getColor(com.example.ilip.R.styleable.OtpView_OtpCursorColor, getCurrentTextColor());
        cursorWidth = typedArray.getDimensionPixelSize(com.example.ilip.R.styleable.OtpView_OtpCursorWidth,
                res.getDimensionPixelSize(com.example.ilip.R.dimen.otp_view_cursor_width));
        itemBackground = typedArray.getDrawable(com.example.ilip.R.styleable.OtpView_android_itemBackground);
        hideLineWhenFilled = typedArray.getBoolean(com.example.ilip.R.styleable.OtpView_OtpHideLineWhenFilled, false);
        rtlTextDirection = typedArray.getBoolean(com.example.ilip.R.styleable.OtpView_OtpRtlTextDirection, false);
        maskingChar = typedArray.getString(com.example.ilip.R.styleable.OtpView_OtpMaskingChar);
        isAllCaps = typedArray.getBoolean(com.example.ilip.R.styleable.OtpView_android_textAllCaps, false);
        typedArray.recycle();
        if (lineColor != null) {
